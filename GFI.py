...
model.load_state_dict(torch.load("cnn_seismic_model_06_05.pth", map_location=device))
model.eval()
...
kernel = cv2.getStructuringElement(cv2.MORPH_RECT, (7, 5)) #6,5
...
# ------------------------------------------------------------
limiar_confiança = 0.75  # Mostra apenas predições com 85% ou mais de confiança
